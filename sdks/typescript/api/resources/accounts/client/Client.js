...
class Accounts {
    ...
    async listAccounts(request = {}) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, "accounts"),
            method: "GET",
            headers: {
    ...
    async getAccount(accountId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, `accounts/${accountId}`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "API-Key": await core.Supplier.get(this.options.apiKey),
     ...
     * @throws {ApitureApi.UnprocessableEntity}
     */
    async listAccountBalances(request = {}) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, "accountBalances"),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "API-Key": await core.Supplier.get(this.options.apiKey),
     ...
     * @throws {ApitureApi.UnprocessableEntity}
     */
    async listEligibleAchAccounts(request) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, "achEligibleAccounts"),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "API-Key": await core.Supplier.get(this.options.apiKey),
     ...
     * @throws {ApitureApi.NotFound}
     */
    async listAccountJointOwners(accountId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, `accounts/${accountId}/jointOwners`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "API-Key": await core.Supplier.get(this.options.apiKey),
     ...
     * @throws {ApitureApi.UnprocessableEntity}
     */
    async createJointOwnerInvitation(accountId, request) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, `accounts/${accountId}/jointOwnerInvitations`),
            method: "POST",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "API-Key": await core.Supplier.get(this.options.apiKey),
     ...
     * @throws {ApitureApi.UnprocessableEntity}
     */
    async listEligibleOverdraftAccounts(accountId, request = {}) {
        ...
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, `accounts/${accountId}/eligibleOverdraftAccounts`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "API-Key": await core.Supplier.get(this.options.apiKey),
     ...
     * @throws {ApitureApi.NotFound}
     */
    async getOverdraftProtection(accountId) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, `accounts/${accountId}/overdraftProtection`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "API-Key": await core.Supplier.get(this.options.apiKey),
     ...
     * @throws {ApitureApi.UnprocessableEntity}
     */
    async patchOverdraftAccounts(accountId, request) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)(this.options.environment, `accounts/${accountId}/overdraftProtection`),
            method: "PATCH",
            headers: {
