 ...
 *
 */
export declare type CutoffTimeType = "ach" | "sameDayAch" | "domesticWireTransfer" | "internationalWireTransfer" | "internalTransfer" | "externalTransfer" | "billPay";
export declare const CutoffTimeType: {
    readonly Ach: "ach";
    readonly SameDayAch: "sameDayAch";
    readonly DomesticWireTransfer: "domesticWireTransfer";
    readonly InternationalWireTransfer: "internationalWireTransfer";
    readonly InternalTransfer: "internalTransfer";
    readonly ExternalTransfer: "externalTransfer";
