 ...
 *
 */
export declare type TransferDateRestrictionType = "pastDate" | "pastCutoffTime" | "riskRestricted" | "holiday" | "closure" | "other";
export declare const TransferDateRestrictionType: {
    readonly PastDate: "pastDate";
    readonly PastCutoffTime: "pastCutoffTime";
    readonly RiskRestricted: "riskRestricted";
